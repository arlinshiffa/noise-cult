...
class hotel_galaxy_service_widget extends WP_Widget {
	...
	public function widget( $args , $instance ) {
		...
		<div class="col-md-4 col-sm-6 animate zoomIn" data-anim-type="zoomIn" data-anim-delay="200">
			<div class="feature-col service-item">
				...
				if( $instance['icon']!=''){
					?>
					<a class="sr-icon" href="<?php echo esc_url( $instance['btn_url'] ); ?>"><i class="fa <?php echo esc_attr( $instance['icon'] ); ?>" style="color:<?php echo esc_attr($instance['icon_color']!='') ? $instance['icon_color'] : '#a29060' ?>"></i></a>
					<?php
				}
				?>
				...
				if($instance['btn_text']!=''){
					...
					<div class="text-center">
						<a href="<?php echo esc_url( $instance['btn_url'] ); ?>" class="custom-btn book-sm" <?php if(isset($instance['btn_target'])) echo 'target="_blank"'; ?> style="background:<?php echo esc_attr($instance['icon_color']!='') ? $instance['icon_color'] : '#dbb26b' ?>">
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Service Icon: { like: fa-cloud } ','hotel-galaxy' ); ?><a href="//fortawesome.github.io/Font-Awesome/icons/" target="_blank" ><?php _e('Click Here!','hotel-galaxy'); ?></a></label> 
