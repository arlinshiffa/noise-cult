<?php
	...
	if( JANNAH_AMP_IS_ACTIVE ){
		...
		jannah_theme_option(
			array(
				'name'   => esc_html__( 'Enable AMP', 'jannah' ),
				'id'     => 'amp_active',
				'type'   => 'checkbox',
		...
		jannah_theme_option(
			array(
				'text' =>  wp_kses_post( sprintf( __( 'You need to install the <a target="_blank" href="%s">Automattic AMP plugin</a> first.', 'jannah' ), 'https://wordpress.org/plugins/amp/' ) ),
				'type' => 'error',
			));
		}
