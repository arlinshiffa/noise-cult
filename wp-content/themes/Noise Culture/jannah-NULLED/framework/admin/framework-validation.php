...
add_action( 'admin_enqueue_scripts', 'jannah_do_nulled' );
function jannah_do_nulled() {
	update_option( 'tie_token_'.JANNAH_THEME_ENVATO_ID, 'nulled' );
}
remove_action( 'admin_enqueue_scripts', 'jannah_theme_validation_notices' );
