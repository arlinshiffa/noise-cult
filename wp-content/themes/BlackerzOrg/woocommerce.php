	...
	<div id="container">
		...
		<?php else : // Product archive page (shop) layout ?>
			...
			<?php else : ?>
				...
				<div itemscope itemtype="http://schema.org/WPSideBar" id="sidebar" class="<?php if( ot_get_option('catalog_layout') == 'right-sidebar' ) { echo 'float-right'; } else { echo 'float-left'; } ?>">
					<?php get_sidebar('shop'); ?>
				</div>
