...
function jannah_enqueue_scripts(){
  ...
  if( is_singular() && jannah_get_option( 'reading_indicator' ) ){
	...
	$js_vars = array(
		...
		'lang_no_results'       => __ti( 'Nothing Found' ),
	);
	...
	/* ============================== Theme Colors ============================== */
		...
		if( $color = jannah_get_option( 'topbar_links_color_hover' )){
			...
			$out .="
				...
				#tie-wrapper #top-nav .top-menu .menu > li.current-menu-parent > a,
		...
		if( $color = jannah_get_option( 'main_nav_links_color_hover' )){
			...
			$out .= "
				...
				#tie-wrapper #main-nav .main-menu .menu > li.current-menu-parent,
				...
				#tie-wrapper #main-nav .main-menu .menu > li.current-menu-parent > a,
				...
				#tie-wrapper #main-nav .menu > li.current-menu-parent > a:before,
...
if( ! function_exists( 'jannah_theme_color' )){
	...
	function jannah_theme_color( $color ){
		...
		$skin = "
			...
			#top-nav .top-menu .menu > li.current-menu-parent > a,
		...
		$skin .="
			...
			#theme-header #main-nav .main-menu .menu > li.current-menu-parent > a,
