<?php
	...
	<div class="foxpush-intro">
		<a href="<?php echo esc_url( 'https://tielabs.com/go/foxpush-jannah' ); ?>" target="_blank" class="navbar-brand smooth-scroll">
			<object type="image/svg+xml" style="max-width: 380px;pointer-events: none;" data="<?php echo JANNAH_TEMPLATE_URL ?>/framework/admin/assets/images/foxpush.svg"></object>
		</a>
		...
		<a class="tie-primary-button button button-primary button-hero" href="<?php echo esc_url( 'https://tielabs.com/go/foxpush-jannah' ); ?>" target="_blank"><?php esc_html_e( 'Sign up for FREE', 'jannah' ) ?></a>
