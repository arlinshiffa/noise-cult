...
function hotel_galaxy_cssfile(){
	...
	wp_enqueue_style('hotel-google-font','https://fonts.googleapis.com/css?family=' . ( esc_attr(($hotel_galaxy_settings['google_font']!='') ? $hotel_galaxy_settings['google_font'] : 'Jura') ));
}
