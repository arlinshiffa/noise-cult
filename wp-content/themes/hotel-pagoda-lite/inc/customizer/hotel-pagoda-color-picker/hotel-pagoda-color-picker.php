 ...
 */
class Hotel_Pagoda_Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'hotel-pagoda-color-picker-js',
			get_template_directory_uri() . '/inc/customizer/hotel-pagoda-color-picker/hotel-pagoda-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),
			'1.0.0',
			true
		);
		wp_enqueue_style(
			'hotel-pagoda-color-picker-css',
			get_template_directory_uri() . '/inc/customizer/hotel-pagoda-color-picker/hotel-pagoda-color-picker.css',
