...
if ( ! class_exists( 'Travel_Company_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Travel_Company_Demo {

		/**
		 * Singleton instance of Travel_Company_Demo.
		 *
		 * @var Travel_Company_Demo $instance Travel_Company_Demo instance.
		 */
		...
		/**
		 * Main Travel_Company_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Travel_Company_Demo ) ) {
				self::$instance = new Travel_Company_Demo();
