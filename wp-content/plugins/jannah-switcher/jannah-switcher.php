...
class JANNAH_SWITCHER_CLASS {
	...
	function __construct() {
		...
		load_plugin_textdomain( 'jannah_switcher', false, '/force-regenerate-thumbnails/localization');
		...
		# -----
		$this->menu_id = 'jannah_page_tie-posts-switcher';
	...
	function switcher_interface() {
		...
		if ( ! empty( $_POST['jannah-switcher'] ) ) {
			...
			if( $is_switched = get_option( 'switch_to_jannah' ) ){
			...
			if( $yes_update == true ){
				update_option( 'switch_to_jannah', $_POST['the_theme'] .'.'. $count );
			...
			$pointer   = 'jannah_switcher_notice';
		...
		# No button click? Display the form ----------
			...
			<form method="post" action="">
				...
				<?php
					...
					$previous_themes = TIE_POSTS_SWITCHER::_detect_themes( false );
