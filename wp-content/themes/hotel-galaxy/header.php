					...
					<div class="row" style="height:35px;">
						...
						<div class="col-md-4">			
							<ul class="header-social-icon pull-right animate fadeInRight">
								...
								<?php if($option['facebook_link']!=''){?><li><a href="<?php echo esc_url($option['facebook_link']); ?>" target="<?php if($option['social_open_new_tab']=='1'){echo '_blank';} ?>" class="facebook" data-toggle="tooltip" title="<?php esc_attr_e('Facebook','hotel-galaxy'); ?>"><i class="fa fa-facebook"></i></a></li><?php } ?>

								<?php if($option['twitter_link']!=''){?><li><a href="<?php echo esc_url($option['twitter_link']); ?>" target="<?php if($option['social_open_new_tab']=='1'){echo '_blank';} ?>" class="twitter" data-toggle="tooltip" title="<?php esc_attr_e('Twitter','hotel-galaxy'); ?>"><i class="fa fa-twitter"></i></a></li><?php } ?>
								<?php if($option['skyup_link']!=''){?><li><a href="<?php echo esc_url($option['skyup_link']); ?>" target="<?php if($option['social_open_new_tab']=='1'){echo '_blank';} ?>" class="skype" data-toggle="tooltip" title="<?php esc_attr_e('Skype','hotel-galaxy'); ?>"><i class="fa fa-skype"></i></a></li><?php } ?>
								<?php if($option['googleplus_link']!=''){?><li><a href="<?php echo esc_url($option['googleplus_link']); ?>" target="<?php if($option['social_open_new_tab']=='1'){echo '_blank';} ?>" class="google-plus" data-toggle="tooltip" title="<?php esc_attr_e('Google-Plus','hotel-galaxy'); ?>"><i class="fa fa-google-plus"></i></a></li><?php } ?>
